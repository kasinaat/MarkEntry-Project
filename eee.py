...
cur = conn.cursor()
cur.execute("SELECT * from mark_list where roll_no like '__e%' order by(roll_no)")
mark = cur.fetchall()
print('''<html>
<head>
...
<div class="row" >
			...
			<div class="dropdown">
				<span ><button class="btn " s>Users</button></span>
					<div class="dropdown-content" style="background-color: #CB7230;">
						...
						<li><a href="removeuser.py">Remove</a></li>
					</div>
			</div>
		</div>
		<div class="col-xs-2">
	...
	<div class = "col-xs-12">
	<button class = "btn btn-success">Export as Sheet</button>
	<script>
